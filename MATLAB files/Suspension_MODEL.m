%{ 
Name:Anshul Kulhari
Project:Railway active vehicle suspension
%}
...
p(2).LineWidth = 1.2;
grid
title ('\fontsize{17}Time response of the Rail disturbance Input (RDI)') 
xlabel('\fontsize{20}Time (secs)') 
ylabel('\fontsize{20}Disturbance Height(m)'); 
legend({'Filtered','Unfiltered'},'FontSize',16,'FontWeight','bold')

print('-f10','Time response of the Rail disturbance input(RDI)','-dpng','-r0')
...
p(1).LineWidth = 0.8;
grid
title ('\fontsize{17}Time response of the filtered velocity of the Rail Disturbance Input (RDI)') 
xlabel('\fontsize{20}Time (secs)') 
ylabel('\fontsize{20}Rail Disturbance Velocity(m/s)'); 
legend({'Filtered response'},'FontSize',16,'FontWeight','bold')

print('-f11','Time response of the filtered velocity of the Rail Disturbance Input (RDI)','-dpng','-r0')
...
p(1).LineWidth = 0.8
grid
title ('\fontsize{17}Time response of the unfiltered velocity of the Rail Disturbance Input (RDI)') 
xlabel('\fontsize{20}Time (secs)') 
ylabel('\fontsize{20}Rail Disturbance Velocity(m/s)'); 
legend({'Unfiltered response'},'FontSize',16,'FontWeight','bold')

print('-f12','Time response of the unfiltered velocity of the Rail Disturbance Input(RDI)','-dpng','-r0')
...
print('-f13','Time response of the filtered & unfiltered velocity of the Rail Disturbance Input (RDI)','-dpng','-r0')
